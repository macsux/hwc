...
namespace Nuke
{
    public static class BuildExtensions
    {
        ...
        {
            var msbuildProject = project.GetMSBuildProjectEx();
        ...
        // public static string[] GetPublishTargetCombination(this Project project) => 


        #region Extended project MSBuild
        
        public static T GetPropertyValue<T>(this Microsoft.Build.Evaluation.Project project, string property) where T : class
        {
        ...
        {
            value = project.GetProperty(property)?.EvaluatedValue;
