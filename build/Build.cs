...
[AzurePipelines(AzurePipelinesImage.Ubuntu1604, InvokedTargets = new[]{nameof(CI)})]
partial class Build : NukeBuild, INuget, IGit
{
    ...
    public Target EnsureCommit => _ => _
        .Inherit<IGit>(x => x.EnsureCommit);
